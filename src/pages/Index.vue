<template>
  <Layout>
    ...
    <div style="margin-top: 50px">
      ...
      <p>木材：使用北美进口GLC，Baillie等品牌标准烘烤木材（白蜡木、白橡木、樱桃木、黑胡桃木），符合FSC标准，闪电拼缝，大板直拼。通体无辅料，不使用贴皮板、齿接板，三层加芯板，不使用松木、泡桐、橡胶木等低质木材。</p>
      <p>涂料：使用德国欧诗木(OSMO)木蜡油。</p>
      <p>乳胶：使用德国汉高(Henkel)拼板乳胶。</p>
      <p>五金：使用德国海蒂诗(Hettich)等品牌五金件。</p>
      <p>工艺：小件家具（斗柜、电视柜、桌椅等），为榫卯结构整装工艺。大件家具（床，衣柜、书柜），为活榫卯配合金属螺栓工艺。家具精细打磨，无死角。</p>
      <p>订制方式：全国物流可达城市均可上门量尺订制，送货安装。</p>
    </div>
    <div style="margin-top: 50px">
